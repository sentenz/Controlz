...
import com.sentenz.controlz.drawerItems.CustomPrimaryDrawerItem
import com.sentenz.controlz.drawerItems.CustomUrlPrimaryDrawerItem
import com.sentenz.controlz.drawerItems.OverflowMenuDrawerItem
...
class AdvancedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle(R.string.drawer_advanced_drawer)
        ...
        profile = ProfileDrawerItem().withName("Sentenz").withEmail("info@sentenz.eu").withIcon(resources.getDrawable(R.drawable.profile))
        ...
        slider.apply {
            itemAdapter.add(
                    PrimaryDrawerItem().withName(R.string.drawer_home).withIcon(FontAwesome.Icon.faw_home),
                    //here we use a customPrimaryDrawerItem we defined in our sample app
                    //this custom DrawerItem extends the PrimaryDrawerItem so it just overwrites some methods
                    OverflowMenuDrawerItem().withName(R.string.drawer_menu_drawer_item).withDescription(R.string.drawer_menu_drawer_item_desc).withMenu(R.menu.fragment_menu).withOnMenuItemClickListener(PopupMenu.OnMenuItemClickListener { item ->
                    ...
                    CustomPrimaryDrawerItem().withBackgroundRes(R.color.accent).withName(R.string.drawer_free_play).withIcon(FontAwesome.Icon.faw_gamepad),
                    PrimaryDrawerItem().withName(R.string.drawer_custom).withDescription("This is a description").withIcon(FontAwesome.Icon.faw_eye),
                    CustomUrlPrimaryDrawerItem().withName(R.string.drawer_fragment_drawer).withDescription(R.string.drawer_fragment_drawer_desc).withIcon("https://avatars3.githubusercontent.com/u/1476232?v=3&s=460"),
                    SectionDrawerItem().withName(R.string.drawer_section_header),
                    SecondaryDrawerItem().withName(R.string.drawer_settings).withIcon(FontAwesome.Icon.faw_cart_plus),
                    SecondaryDrawerItem().withName(R.string.drawer_help).withIcon(FontAwesome.Icon.faw_database).withEnabled(false),
                    SecondaryDrawerItem().withName(R.string.drawer_open_source).withIcon(FontAwesome.Icon.faw_github),
                    SecondaryDrawerItem().withName(R.string.drawer_contact).withIconTintingEnabled(true).withIcon(IconicsDrawable(this@AdvancedActivity, GoogleMaterial.Icon.gmd_add).apply { actionBar(); paddingDp = 5 }).withTag("Bullhorn"),
