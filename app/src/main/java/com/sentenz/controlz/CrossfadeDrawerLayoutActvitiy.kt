...
class CrossfadeDrawerLayoutActvitiy : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle(R.string.drawer_crossfade_drawer_layout_drawer)
        ...
        crossFadeLargeView.apply {
            itemAdapter.add(
                    ...
                    PrimaryDrawerItem().withName(R.string.drawer_settings).withIcon(FontAwesome.Icon.faw_cog),
                    PrimaryDrawerItem().withName(R.string.drawer_help).withIcon(FontAwesome.Icon.faw_question).withEnabled(false),
                    PrimaryDrawerItem().withName(R.string.drawer_open_source).withIcon(FontAwesome.Icon.faw_github),
                    PrimaryDrawerItem().withName(R.string.drawer_contact).withIcon(FontAwesome.Icon.faw_bullhorn)
            )
