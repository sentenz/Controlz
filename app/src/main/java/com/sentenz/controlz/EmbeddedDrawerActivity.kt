...
class EmbeddedDrawerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle(R.string.drawer_embedded_drawer)
        ...
        slider.apply {
            ...
            itemAdapter.add(
                    ...
                    PrimaryDrawerItem().withName(R.string.drawer_action_bar_drawer).withIcon(FontAwesome.Icon.faw_home).withBadge("22").withBadgeStyle(BadgeStyle(Color.RED, Color.RED)).withIdentifier(2),
