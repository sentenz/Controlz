    ...
    private fun navigationDrawer(savedInstanceState: Bundle?) {
        ...
        slider.apply {
            ...
            onDrawerItemClickListener = { v, drawerItem, position ->
                ...
                when {
                    drawerItem.identifier == 1001L -> intent = Intent(this@DrawerActivity, ControlActivity::class.java)
                    drawerItem.identifier == 3L -> intent = Intent(this@DrawerActivity, PaternosterActivity::class.java)
